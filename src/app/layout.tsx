...
export const metadata: Metadata = {
  ...
  description:
    "A T3 Stack boilerplate with Better-Auth integration, featuring Next.js, TypeScript, Tailwind CSS, tRPC, and Prisma for full-stack type-safety",
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "A T3 Stack boilerplate with Better-Auth integration",
              url: "https://t3.xeesol.net",
              potentialAction: {
                "@type": "SearchAction",
